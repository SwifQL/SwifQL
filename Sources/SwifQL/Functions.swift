...
extension Fn {
    public struct Name {
        ...
        public static var substr: Name = .init("substr")
        public static var coalesce: Name = .init("coalesce")
        public static var octet_length: Name = .init("octet_length")
        public static var cast: Name = .init("cast")
        public static var ifnull: Name = .init("ifnull")
        public static var isnull: Name = .init("isnull")
        public static var nvl: Name = .init("nvl")
        public static var expression: Name = .init("expression")
        
        // MARK: String
        
        public static var bit_length: Name = .init("bit_length")
        public static var btrim: Name = .init("btrim")
        public static var char_length: Name = .init("char_length")
        public static var character_length: Name = .init("character_length")
        public static var initcap: Name = .init("initcap")
        public static var concat: Name = .init("concat")
        public static var concat_ws: Name = .init("concat_ws")
        public static var array_length: Name = .init("array_length")
        public static var length: Name = .init("length")
        public static var lower: Name = .init("lower")
        public static var lpad: Name = .init("lpad")
        public static var ltrim: Name = .init("ltrim")
        public static var position: Name = .init("position")
        public static var `repeat`: Name = .init("repeat")
        public static var replace: Name = .init("replace")
        public static var rpad: Name = .init("rpad")
        public static var rtrim: Name = .init("rtrim")
        public static var strpos: Name = .init("strpos")
        public static var substring: Name = .init("substring")
        ...
        public static var abs: Name = .init("abs")
        public static var avg: Name = .init("avg")
        public static var ceil: Name = .init("ceil")
        public static var ceiling: Name = .init("ceiling")
        public static var count: Name = .init("count")
        public static var div: Name = .init("div")
        public static var exp: Name = .init("exp")
        public static var floor: Name = .init("floor")
        public static var max: Name = .init("max")
        public static var min: Name = .init("min")
        public static var mod: Name = .init("mod")
        public static var power: Name = .init("power")
        public static var random: Name = .init("random")
        public static var round: Name = .init("round")
        public static var setseed: Name = .init("setseed")
        public static var sign: Name = .init("sign")
        public static var sqrt: Name = .init("sqrt")
        public static var sum: Name = .init("sum")
        
        // MARK: Postgres JSON
        
        public static var json_agg: Name = .init("json_agg")
        public static var to_json: Name = .init("to_json")
        public static var array_to_json: Name = .init("array_to_json")
        public static var row_to_json: Name = .init("row_to_json")
        public static var json_build_array: Name = .init("json_build_array")
        public static var json_build_object: Name = .init("json_build_object")
        public static var json_object: Name = .init("json_object")
        public static var json_array_length: Name = .init("json_array_length")
        public static var json_each: Name = .init("json_each")
        public static var json_each_text: Name = .init("json_each_text")
        public static var json_extract_path: Name = .init("json_extract_path")
        public static var json_extract_path_text: Name = .init("json_extract_path_text")
        public static var json_object_keys: Name = .init("json_object_keys")
        public static var json_populate_record: Name = .init("json_populate_record")
        public static var json_populate_recordset: Name = .init("json_populate_recordset")
        public static var json_array_elements: Name = .init("json_array_elements")
        public static var json_array_elements_text: Name = .init("json_array_elements_text")
        public static var json_typeof: Name = .init("json_typeof")
        public static var json_to_record: Name = .init("json_to_record")
        public static var json_to_recordset: Name = .init("json_to_recordset")
        public static var json_strip_nulls: Name = .init("json_strip_nulls")
        
        // MARK: Postgres JSONB
        
        public static var jsonb_agg: Name = .init("jsonb_agg")
        public static var to_jsonb: Name = .init("to_jsonb")
        public static var jsonb_build_array: Name = .init("jsonb_build_array")
        public static var jsonb_build_object: Name = .init("jsonb_build_object")
        public static var jsonb_object: Name = .init("jsonb_object")
        public static var jsonb_array_length: Name = .init("jsonb_array_length")
        public static var jsonb_each: Name = .init("jsonb_each")
        public static var jsonb_each_text: Name = .init("jsonb_each_text")
        public static var jsonb_extract_path: Name = .init("jsonb_extract_path")
        public static var jsonb_extract_path_text: Name = .init("jsonb_extract_path_text")
        public static var jsonb_object_keys: Name = .init("jsonb_object_keys")
        public static var jsonb_populate_record: Name = .init("jsonb_populate_record")
        public static var jsonb_populate_recordset: Name = .init("jsonb_populate_recordset")
        public static var jsonb_array_elements: Name = .init("jsonb_array_elements")
        public static var jsonb_array_elements_text: Name = .init("jsonb_array_elements_text")
        public static var jsonb_typeof: Name = .init("jsonb_typeof")
        public static var jsonb_to_record: Name = .init("jsonb_to_record")
        public static var jsonb_to_recordset: Name = .init("jsonb_to_recordset")
        public static var jsonb_strip_nulls: Name = .init("jsonb_strip_nulls")
        public static var jsonb_set: Name = .init("jsonb_set")
        public static var jsonb_insert: Name = .init("jsonb_insert")
        public static var jsonb_pretty: Name = .init("jsonb_pretty")
        
        // MARK: Postgres time
        
        public static var age: Name = .init("age")
        public static var clock_timestamp: Name = .init("clock_timestamp")
        public static var current_date: Name = .init("current_date")
        public static var current_time: Name = .init("current_time")
        public static var current_timestamp: Name = .init("current_timestamp")
        public static var date_part: Name = .init("date_part")
        public static var date_trunc: Name = .init("date_trunc")
        public static var extract: Name = .init("extract")
        public static var isfinite: Name = .init("isfinite")
        public static var justify_days: Name = .init("justify_days")
        public static var justify_hours: Name = .init("justify_hours")
        public static var justify_interval: Name = .init("justify_interval")
        public static var localtime: Name = .init("localtime")
        public static var localtimestamp: Name = .init("localtimestamp")
        public static var make_date: Name = .init("make_date")
        public static var make_interval: Name = .init("make_interval")
        public static var make_time: Name = .init("make_time")
        public static var make_timestamp: Name = .init("make_timestamp")
        public static var make_timestamptz: Name = .init("make_timestamptz")
        public static var now: Name = .init("now")
        public static var statement_timestamp: Name = .init("statement_timestamp")
        public static var timeofday: Name = .init("timeofday")
        public static var transaction_timestamp: Name = .init("transaction_timestamp")
        public static var to_timestamp: Name = .init("to_timestamp")
        
        // MARK: Postgres series
        
        public static var generate_series: Name = .init("generate_series")

        // MARK: Array
        
        public static var array_agg: Name = .init("array_agg")
        public static var array_remove: Fn.Name = .init("array_remove")
        
        // MARK: Text Search
        
        public static var to_tsvector: Name = .init("to_tsvector")
        public static var to_tsquery: Name = .init("to_tsquery")
        public static var plainto_tsquery: Name = .init("plainto_tsquery")
        public static var ts_rank_cd: Name = .init("ts_rank_cd")
